        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" method="POST" action="{{ route('vehicles.update', ['vehicle' => $vehicle['id']]) }}" enctype="multipart/form-data">
                            @method('PATCH')
                            @csrf
                            <div class="col-md-8">
                            ...
                            <div class="col-md-8">
                                ...
                                <textarea rows="4" cols="50" name="description">{{ $vehicle->description }}</textarea>
                            </div>
                            <div class="col-md-8">
                                <label>Image</label>
